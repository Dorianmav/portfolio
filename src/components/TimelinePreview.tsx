            ...
            {filteredItems.map((item, index) => (
              ...
              >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: getCategoryColor(item.category) }}>
                ...
                <div className="md:w-1/2 md:px-7">
                  ...
                  >
                    ...
                    {item.link ? (
                      <a href={item.link} target="_blank" rel="noreferrer" className="flex items-center text-sm" style={{
                        color: themeColors.text,
                    ...
                    {selectedItem === item.id && (
                      <div className="mt-4 pt-4" style={{ borderTop: `1px solid ${themeColors.border}` }}>
                        {item.details && item.details.length > 0 && (
                          <>
                            <h4 className="text-md font-semibold mb-2" style={{ color: themeColors.text }}>
                              {t("timeline.details")}:
                            </h4>
                            <ul className="list-disc list-inside space-y-1">
                              {item.details?.map((detail, i) => (
                                <li key={`${item.id}-detail-${i}`} style={{ color: themeColors.text }}>
                                  {detail}
                                </li>
                              ))}
                            </ul>
                          ...
                          <div className="mt-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {item.technologies.map((tech, i) => (
                                <span key={`${item.id}-tech-${i}`} className="px-2 py-1 rounded-full text-sm" 
                                  style={{
